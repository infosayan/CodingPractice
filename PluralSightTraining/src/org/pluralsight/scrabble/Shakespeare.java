...
public class Shakespeare {
	...
	public static void main(String[] args) throws IOException {
		...
		Set<String> shakespeareWords = Files.lines(Paths.get("C:\\Users\\m1049799\\workspace\\PluralSightTraining\\src\\org\\pluralsight\\scrabble\\words.shakespeare.txt"))
										.map(word -> word.toLowerCase())
										.collect(Collectors.toSet());
		
		Set<String> scrabbleWords = Files.lines(Paths.get("C:\\Users\\m1049799\\workspace\\PluralSightTraining\\src\\org\\pluralsight\\scrabble\\ospd.txt"))
				.map(word -> word.toLowerCase())
				.collect(Collectors.toSet());
